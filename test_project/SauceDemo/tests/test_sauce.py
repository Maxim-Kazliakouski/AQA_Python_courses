...
class Test_sauce_demo:
    ...
    def test_login_and_log_output(self, browser, logs, number_items, printing_name_case):
        item_name_list = []
        creds = []
        password = []
        ...
        def item_description_func(item_name_from_certain_good):
